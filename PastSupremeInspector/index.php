<?php 
  ...
  <?php include(LOGIN . "login_header.php"); ?>
     <div class="freehand-h1"><div class="Green">Past Supreme Inspector</div></div>
    ...
    <table width="700" border="0">
      <tr>
        <td width="375">
          <h2 align="center">Member of the House of Gold <hr /></h2> 
          <h4 align="center">Past Grand Worthy Advisor<br />
            Grand Assembly of New Mexico<br />
            1956-1957
          </h4>
          <h3>&dagger; Past Supreme Chaplain<br />
              &dagger; Past Supreme Drill Leader<br />
